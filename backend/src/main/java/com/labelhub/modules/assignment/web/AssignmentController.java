...
public class AssignmentController {
    ...
    @PostMapping("/claim")
    public ApiResponse<AssignmentClaimResponse> claim(@RequestHeader("X-User-Id") Long labelerId,
                                                      @PathVariable Long taskId) {
        return ApiResponse.ok(assignmentClaimService.claim(taskId, labelerId));
    }
}
