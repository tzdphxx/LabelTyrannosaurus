...
class ApiContractMappingTest {
    ...
    void p0AndP1ContractEndpointsHaveControllerMappings() {
        ...
        assertThat(actual).containsAll(List.of(
                ...
                endpoint("POST", "/api/v1/tasks/{taskId}/dataset/import"),
                endpoint("POST", "/api/v1/tasks/{taskId}/dataset/import/overwrite"),
                ...
                endpoint("POST", "/api/v1/tasks/{taskId}/assignments/claim"),
                endpoint("GET", "/api/v1/assignments/{assignmentId}"),
                endpoint("PUT", "/api/v1/assignments/{assignmentId}/draft"),
                ...
                endpoint("PUT", "/api/v1/llm-providers/{providerId}"),
                endpoint("POST", "/api/v1/llm-providers/{providerId}/enable"),
                endpoint("POST", "/api/v1/llm-providers/{providerId}/disable"),
                endpoint("POST", "/api/v1/llm-providers/{providerId}/test"),
                endpoint("POST", "/api/v1/llm/triggers/run"),
                ...
                endpoint("POST", "/api/v1/reviewer/submissions/claim"),
    ...
    private static List<String> controllerClassNames() {
        return Arrays.asList(
                ...
                "com.labelhub.modules.assignment.web.AssignmentController",
                "com.labelhub.modules.assignment.web.AssignmentDetailController",
                "com.labelhub.modules.assignment.web.AssignmentDraftController",
                ...
                "com.labelhub.modules.submission.web.AssignmentSubmitController",
