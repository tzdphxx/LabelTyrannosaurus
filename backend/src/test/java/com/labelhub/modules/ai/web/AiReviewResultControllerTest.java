...
class AiReviewResultControllerTest {
    ...
    void readsCurrentUserWhenQueryingSubmissionAiReviewResult() {
        AiReviewResultController controller = new AiReviewResultController(queryService, currentUserContext);
        CurrentUser reviewer = new CurrentUser(1L, "reviewer", Set.of(RoleCode.REVIEWER), 1);
        ...
        when(currentUserContext.currentUser()).thenReturn(reviewer);
