...
class LlmTriggerControllerTest {
    ...
    void passesCurrentUserToService() {
        LlmTriggerController controller = new LlmTriggerController(llmTriggerService, currentUserContext);
        CurrentUser currentUser = new CurrentUser(2L, "labeler", Set.of(RoleCode.LABELER), 1);
        ...
        LlmTriggerRunResponse serviceResponse = new LlmTriggerRunResponse(60L, "assist",
                ...
                12L, null, null);
        when(currentUserContext.currentUser()).thenReturn(currentUser);
