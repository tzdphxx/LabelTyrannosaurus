...
export function OwnerDashboardPage() {
  ...
  return (
    <main className="owner-page">
      <ContentShell className="owner-hero">
        <PageHeader
          title="任务负责人工作台"
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col lg={4} md={12} xs={24}>
          <Card className="owner-stat-card owner-stat-card--alert">
      ...
      <Row gutter={[16, 16]}>
        <Col lg={10} xs={24}>
          ...
          >
            {focusedTask ? (
              <Space className="owner-progress-card__content" direction="vertical" size={16}>
                <div>
        ...
        <Col lg={14} xs={24}>
          <Card className="owner-table-card" title="最近任务">
            <Table<OwnerTask>
              columns={[
                {
                  title: '任务',
